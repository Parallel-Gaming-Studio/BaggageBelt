class luggage_yellow extends Shape {
    constructor(pos) {
        // Position
        var _position = (typeof pos !== "undefined") ? pos : new Vector2D();
        // Type
        var _type = typeEnum.type_luggage_yellow;
        // Luggage Reference
        var _targetLuggage = game.playLuggageYellow;
        // Image
    ...
    draw() {
		this.adjustStyles();
        // console.log(`<LuggageYellow>[Draw] Image: ${this.image.id}\nX: ${this.center.x} | Y: ${this.center.y}\nW: ${this.width} | H: ${this.height}`);
