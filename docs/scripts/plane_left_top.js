class plane_left_top extends Shape {
    constructor() {
        // Plane Reference
        var _targetReference = game.playLargePlaneLeft;
        // Type
        var _type = typeEnum.type_plane_left_top;
        // Image
    ...
    drawDropZone() {
        ...
        switch (game.manager.level) {
            case 0:
                pos = this.level1LoadingPosition;
                break;
            case 1:
        ...
        var dropX = pos.x + 592 * (1 - Math.max(engine.widthProportion, engine.heightProportion));
